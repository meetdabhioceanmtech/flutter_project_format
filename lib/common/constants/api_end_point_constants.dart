...
class EnvConstants {
  ...
  static String API_ENDPOINT_4 = 'API_ENDPOINT_4'; // Notification List
  static String API_ENDPOINT_5 = 'API_ENDPOINT_5'; // Privacy Policy
  static String API_ENDPOINT_6 = 'API_ENDPOINT_6'; // Terms and Conditions
}
